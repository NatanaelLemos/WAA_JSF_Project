...
public class Departure {
    ...
    public void setFlightnr(String flightnr) { this.flightnr = flightnr; }

    public String getDepartureDate() { return df.format(departureDate); }
    ...
    public String getDepartureTime() { return tf.format(departureTime); }
    ...
    public String getArrivalDate() { return df.format(arrivalDate); }
    ...
    public String getArrivalTime() { return tf.format(arrivalTime); }
